...
#     value = azurerm_mssql_managed_instance.sku_name
# }

# output "name" {
#     description = "The name of the instance"
#     value = azurerm_mssql_managed_instance.name
# }

# output "resource_group_name" {
#     description = "Resource Group where the instance resides"
#     value = azurerm_mssql_managed_instance.resource_group_name
# }

# output "location" {
#     description = "The location where the instance resides"
#     value = azurerm_mssql_managed_instance.location
# }


# output "license_type" {
#     description = "The type of license the instance used"
#     value = azurerm_mssql_managed_instance.license_type
# }
...
#     value = azurerm_mssql_managed_instance.tags
# }
...
#     value = azurerm_mssql_managed_instance.administrator_login
# }
